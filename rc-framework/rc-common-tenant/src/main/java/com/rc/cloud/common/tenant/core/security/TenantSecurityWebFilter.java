package com.rc.cloud.common.tenant.core.security;
...
import com.rc.cloud.common.core.web.filter.ApiRequestFilter;
...
//                ServletUtils.writeJSON(response, CodeResult.fail(GlobalErrorCodeConstants.FORBIDDEN.getCode(),
//                        "您无权访问该租户的数据"));
//                return;
//            }
//        }
        ...
        if (!isIgnoreUrl(request)) {
            ...
            try {
                ...
                CodeResult<?> result = globalExceptionHandler.allExceptionHandler(request, ex);
