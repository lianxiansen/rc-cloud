 ...
 * @author oliveoil
 */
public class RcPage<T> extends Page<T> {
    ...
    public RcPage(int current, int size) {
        this(current, size, 0);
    }

    public RcPage(int current, int size, int total) {
        this(current, size, total, true);
    }

    public RcPage(int current, int size, boolean isSearchCount) {
     ...
     */
    public RcPage(int current, int size, int total, boolean isSearchCount) {
