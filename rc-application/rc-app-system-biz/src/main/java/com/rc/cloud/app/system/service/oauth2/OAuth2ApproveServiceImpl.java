...
public class OAuth2ApproveServiceImpl implements OAuth2ApproveService {
    ...
    void saveApprove(Long userId, Integer userType, String clientId,
        ...
        // 先更新
        OAuth2ApproveDO oAuth2ApproveDO = new OAuth2ApproveDO();
        oAuth2ApproveDO.setUserId(userId);
        oAuth2ApproveDO.setUserType(userType);
        oAuth2ApproveDO.setClientId(clientId);
        oAuth2ApproveDO.setScope(scope);
        oAuth2ApproveDO.setApproved(approved);
        oAuth2ApproveDO.setExpiresTime(expireTime);
        OAuth2ApproveDO approveDO = oAuth2ApproveDO;
