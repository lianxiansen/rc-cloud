...
import com.rc.cloud.app.system.convert.oauth2.OAuth2UserConvert;
...
@RestController
@RequestMapping("/sys/oauth2/user")
@Validated
@Slf4j
...
//    @PreAuthorize("@ss.hasScope('user.read')") //
    public CodeResult<OAuth2UserInfoRespVO> getUserInfo() {
        // 获得用户基本信息
...
//    @PreAuthorize("@ss.hasScope('user.write')")
    public CodeResult<Boolean> updateUserInfo(@Valid @RequestBody OAuth2UserUpdateReqVO reqVO) {
