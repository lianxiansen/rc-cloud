package com.rc.cloud.app.system.controller.admin.oauth2;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.rc.cloud.app.system.common.util.oauth2.OAuth2Utils;
import com.rc.cloud.app.system.convert.oauth2.OAuth2OpenConvert;
import com.rc.cloud.app.system.model.oauth2.OAuth2AccessTokenDO;
import com.rc.cloud.app.system.model.oauth2.OAuth2ApproveDO;
import com.rc.cloud.app.system.model.oauth2.OAuth2ClientDO;
import com.rc.cloud.app.system.service.oauth2.OAuth2ApproveService;
import com.rc.cloud.app.system.service.oauth2.OAuth2ClientService;
import com.rc.cloud.app.system.service.oauth2.OAuth2GrantService;
import com.rc.cloud.app.system.service.oauth2.OAuth2TokenService;
import com.rc.cloud.app.system.vo.oauth2.open.OAuth2OpenAccessTokenRespVO;
import com.rc.cloud.app.system.vo.oauth2.open.OAuth2OpenAuthorizeInfoRespVO;
import com.rc.cloud.app.system.vo.oauth2.open.OAuth2OpenCheckTokenRespVO;
import com.rc.cloud.app.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.rc.cloud.common.core.enums.UserTypeEnum;
import com.rc.cloud.common.core.util.http.HttpUtils;
...
import static com.rc.cloud.common.core.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
...
//    @OperateLog(enable = false) // 避免 Post 请求被记录操作日志
    public CodeResult<OAuth2OpenAccessTokenRespVO> postAccessToken(HttpServletRequest request,
        ...
        return CodeResult.ok(OAuth2OpenConvert.INSTANCE.convert(accessTokenDO));
    }
...
//    @OperateLog(enable = false) // 避免 Post 请求被记录操作日志
    public CodeResult<Boolean> revokeToken(HttpServletRequest request,
        ...
        // 删除访问令牌
        return CodeResult.ok(oauth2GrantService.revokeToken(client.getClientId(), token));
    }
    ...
    @Parameter(name = "token", required = true, description = "访问令牌", example = "biu")
//    @OperateLog(enable = false) // 避免 Post 请求被记录操作日志
    public CodeResult<OAuth2OpenCheckTokenRespVO> checkToken(HttpServletRequest request,
                                                             @RequestParam("token") String token) {
        // 校验客户端
        String[] clientIdAndSecret = obtainBasicAuthorization(request);
        ...
        Assert.notNull(accessTokenDO, "访问令牌不能为空"); // 防御性检查
        return CodeResult.ok(OAuth2OpenConvert.INSTANCE.convert2(accessTokenDO));
    }
    ...
    public CodeResult<OAuth2OpenAuthorizeInfoRespVO> authorize(@RequestParam("clientId") String clientId) {
        ...
        // 拼接返回
        return CodeResult.ok(OAuth2OpenConvert.INSTANCE.convert(client, approves));
    }
...
//    @OperateLog(enable = false) // 避免 Post 请求被记录操作日志
    public CodeResult<String> approveOrDeny(@RequestParam("response_type") String responseType,
        ...
        if (grantTypeEnum == OAuth2GrantTypeEnum.AUTHORIZATION_CODE) {
            return CodeResult.ok(getAuthorizationCodeRedirect(getLoginUserId(), client, approveScopes, redirectUri, state));
        }
        // 3.2 如果是 token 则是 implicit 简化模式，则发送 accessToken 访问令牌，并重定向
        return CodeResult.ok(getImplicitGrantRedirect(getLoginUserId(), client, approveScopes, redirectUri, state));
    }
