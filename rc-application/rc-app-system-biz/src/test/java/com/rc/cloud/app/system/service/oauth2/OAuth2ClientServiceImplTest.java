...
import com.rc.cloud.app.system.mapper.oauth2.OAuth2ClientMapper;
import com.rc.cloud.app.system.model.oauth2.OAuth2ClientDO;
import com.rc.cloud.app.system.vo.oauth2.client.OAuth2ClientCreateReqVO;
import com.rc.cloud.app.system.vo.oauth2.client.OAuth2ClientPageReqVO;
import com.rc.cloud.app.system.vo.oauth2.client.OAuth2ClientUpdateReqVO;
...
//        verify(oauth2ClientProducer).sendOAuth2ClientRefreshMessage();
    ...
    public void testValidateClientIdExists_withId() {
        ...
        oAuth2ClientDO.setClientId("tudou");
    ...
    public void testValidateClientIdExists_noId() {
        ...
        OAuth2ClientDO oAuth2ClientDO = randomPojo(OAuth2ClientDO.class);
        oAuth2ClientDO.setClientId("tudou");
        OAuth2ClientDO client = oAuth2ClientDO;
    ...
    public void testValidOAuthClientFromCache() {
        // mock 方法
        OAuth2ClientDO oAuth2ClientDO1 = randomPojo(OAuth2ClientDO.class);
        oAuth2ClientDO1.setClientId("default");
        oAuth2ClientDO1.setStatus(CommonStatusEnum.ENABLE.getStatus());
        OAuth2ClientDO oAuth2ClientDO2 = randomPojo(OAuth2ClientDO.class);
        oAuth2ClientDO2.setClientId("disable");
        oAuth2ClientDO2.setStatus(CommonStatusEnum.DISABLE.getStatus());
        Map<String, OAuth2ClientDO> clientCache = MapUtil.<String, OAuth2ClientDO>builder()
                .put(oAuth2ClientDO1.getClientId(), oAuth2ClientDO1)
                .put(oAuth2ClientDO2.getClientId(), oAuth2ClientDO2).build();
        ...
        // 成功调用（1：参数完整）
        OAuth2ClientDO result = oauth2ClientService.validOAuthClientFromCache(oAuth2ClientDO1.getClientId(), oAuth2ClientDO1.getSecret(),
                oAuth2ClientDO1.getAuthorizedGrantTypes().get(0), oAuth2ClientDO1.getScopes(), oAuth2ClientDO1.getRedirectUris().get(0));
        assertPojoEquals(oAuth2ClientDO1, result);
        // 成功调用（2：只有 clientId 参数）
        result = oauth2ClientService.validOAuthClientFromCache(oAuth2ClientDO1.getClientId());
        assertPojoEquals(oAuth2ClientDO1, result);
    }
