...
//    private PermissionProducer permissionProducer;
    ...
    public void testInitLocalCacheForRoleMenu() {
        // mock 数据
        SysRoleMenuPO roleMenuDO01 = randomPojo(SysRoleMenuPO.class, o -> {
            o.setRoleId("1");
            o.setMenuId("10");
        });
        roleMenuMapper.insert(roleMenuDO01);
        SysRoleMenuPO roleMenuDO02 = randomPojo(SysRoleMenuPO.class, o -> {
            o.setRoleId("1");
            o.setMenuId("20");
        });
    ...
    public void testInitLocalCacheForUserRole() {
        // mock 数据
        SysUserRolePO userRoleDO01 = randomPojo(SysUserRolePO.class, o -> {
            o.setUserId("1");
            o.setRoleId("10");
        });
        userRoleMapper.insert(userRoleDO01);
        SysUserRolePO roleMenuDO02 = randomPojo(SysUserRolePO.class, o -> {
            o.setUserId("1");
            o.setRoleId("20");
        });
    ...
    public void testGetRoleMenuListFromCache_superAdmin() {
        ...
        // mock 方法
        List<SysRolePO> roleList = singletonList(randomPojo(SysRolePO.class, o -> o.setId("100")));
        ...
        List<SysMenuPO> menuList = randomPojoList(SysMenuPO.class);
        when(menuService.getMenuListFromCache(eq(menuTypes), eq(menusStatuses))).thenReturn(menuList);

        // 调用
        List<SysMenuPO> result = permissionService.getRoleMenuListFromCache(roleIds, menuTypes, menusStatuses);
        // 断言
...
//    }
    ...
    public void testGetUserRoleIdsFromCache() {
        ...
        SysRolePO roleDO01 = randomPojo(SysRolePO.class, o -> o.setStatus(CommonStatusEnum.ENABLE.getStatus()));
        when(roleService.getRoleFromCache(eq("10"))).thenReturn(roleDO01);
        SysRolePO roleDO02 = randomPojo(SysRolePO.class, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus()));
    ...
    public void testGetRoleMenuIds_superAdmin() {
        ...
        menuDO.setId("1");
        List<SysMenuPO> menuList = singletonList(menuDO);
    ...
    public void testGetRoleMenuIds_normal() {
        ...
        String roleId = "100";
        // mock 数据
        SysRoleMenuPO roleMenuDO1 = randomPojo(SysRoleMenuPO.class);
        roleMenuDO1.setRoleId("100");
        roleMenuDO1.setMenuId("1");
        roleMenuMapper.insert(roleMenuDO1);
        SysRoleMenuPO roleMenuDO2 = randomPojo(SysRoleMenuPO.class);
    ...
    public void testAssignRoleMenu() {
        ...
        // 断言
        List<SysRoleMenuPO> roleMenuList = roleMenuMapper.selectList();
...
//        verify(permissionProducer).sendRoleMenuRefreshMessage();
    ...
    public void testAssignUserRole() {
        ...
        // mock 数据
        SysUserRolePO userRoleDO1 = randomPojo(SysUserRolePO.class);
        userRoleDO1.setUserId("1");
        userRoleDO1.setRoleId("100");
        userRoleMapper.insert(userRoleDO1);
        SysUserRolePO userRoleDO2 = randomPojo(SysUserRolePO.class);
        ...
        // 断言
        List<SysUserRolePO> userRoleDOList = userRoleMapper.selectList();
...
//        verify(permissionProducer).sendUserRoleRefreshMessage();
    ...
    public void testGetUserRoleIdListByUserId() {
        ...
        userRoleMapper.insert(userRoleDO01);
        SysUserRolePO userRoleDO02 = randomPojo(SysUserRolePO.class, o -> {
            o.setUserId("1");
            o.setRoleId("20");
        });
    ...
    public void testProcessRoleDeleted() {
        ...
        // mock 数据 UserRole
        SysUserRolePO userRoleDO01 = randomPojo(SysUserRolePO.class, o -> o.setRoleId(roleId)); // 被删除
        userRoleMapper.insert(userRoleDO01);
        SysUserRolePO userRoleDO02 = randomPojo(SysUserRolePO.class); // 不被删除
        userRoleMapper.insert(userRoleDO02);
        // mock 数据 RoleMenu
        SysRoleMenuPO roleMenuDO01 = randomPojo(SysRoleMenuPO.class, o -> o.setRoleId(roleId)); // 被删除
        roleMenuMapper.insert(roleMenuDO01);
        SysRoleMenuPO roleMenuDO02 = randomPojo(SysRoleMenuPO.class); // 不被删除
        roleMenuMapper.insert(roleMenuDO02);

        // 调用
        permissionService.processRoleDeleted(roleId);
        // 断言数据 RoleMenuDO
        List<SysRoleMenuPO> dbRoleMenus = roleMenuMapper.selectList();
        assertEquals(1, dbRoleMenus.size());
        assertPojoEquals(dbRoleMenus.get(0), roleMenuDO02);
        // 断言数据 UserRoleDO
        List<SysUserRolePO> dbUserRoles = userRoleMapper.selectList();
...
//        verify(permissionProducer).sendUserRoleRefreshMessage();
    ...
    public void testProcessMenuDeleted() {
        ...
        // mock 数据
        SysRoleMenuPO roleMenuDO01 = randomPojo(SysRoleMenuPO.class, o -> o.setMenuId(menuId)); // 被删除
        roleMenuMapper.insert(roleMenuDO01);
        SysRoleMenuPO roleMenuDO02 = randomPojo(SysRoleMenuPO.class); // 不被删除
        roleMenuMapper.insert(roleMenuDO02);
...
//        verify(permissionProducer).sendRoleMenuRefreshMessage();
    ...
    public void testProcessUserDeleted() {
        ...
        // mock 数据
        SysUserRolePO userRoleDO01 = randomPojo(SysUserRolePO.class, o -> o.setUserId(userId)); // 被删除
        userRoleMapper.insert(userRoleDO01);
        SysUserRolePO userRoleDO02 = randomPojo(SysUserRolePO.class); // 不被删除
        userRoleMapper.insert(userRoleDO02);
...
//        verify(permissionProducer).sendUserRoleRefreshMessage();
    ...
    public void testHasAnyPermissions_superAdmin() {
        ...
        SysRolePO role = randomPojo(SysRolePO.class, o -> {
            o.setId("100");
    ...
    public void testHasAnyPermissions_normal() {
        ...
        when(roleService.getRoleFromCache(eq("100"))).thenReturn(role);
        // mock 其它方法
        SysMenuPO menu = randomPojo(SysMenuPO.class, o -> o.setId("1000"));
    ...
    public void testGetDeptDataPermission_All() {
        ...
        // mock 获得用户的角色
        SysRolePO roleDO = randomPojo(SysRolePO.class, o -> {
            o.setId("2");
    ...
    public void testGetDeptDataPermission_DeptCustom() {
        ...
        sysUserPO.setDeptId("3");
        when(userService.getUser(eq("1"))).thenReturn(sysUserPO, null, null); // 最后返回 null 的目的，看看会不会重复调用
    ...
    public void testGetDeptDataPermission_DeptAndChild() {
        ...
        when(userService.getUser(eq("1"))).thenReturn(sysUserPO, null, null); // 最后返回 null 的目的，看看会不会重复调用
        // mock 方法（部门）
        SysDeptPO deptDO = randomPojo(SysDeptPO.class);
