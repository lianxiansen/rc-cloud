...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('schedulerName', 'hqf1688720703964', 1688721849603, 15000);
...
INSERT INTO `sys_dept` VALUES ('112', '测试部门007', '0', 0, NULL, NULL, NULL, 0, 'admin', '2023-06-30 17:14:29', 'admin', '2023-07-07 16:51:11', b'0', '1');
...
INSERT INTO `sys_dict_data` VALUES ('1244', 0, '未锁定', '0', 'common_locked', 0, 'success', '', '未锁定', 'admin', '2023-07-06 09:34:27', 'admin', '2023-07-06 09:34:27', b'0');
INSERT INTO `sys_dict_data` VALUES ('1245', 1, '锁定', '1', 'common_locked', 0, 'warning', '', '', 'admin', '2023-07-06 09:34:45', 'admin', '2023-07-07 16:54:44', b'0');
...
INSERT INTO `sys_dict_type` VALUES ('173', '通用是否锁定', 'common_locked', 0, '通用是否锁定', 'admin', '2023-07-06 09:33:52', 'admin', '2023-07-07 16:54:22', b'0');


-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('2162', '产品', '', 1, 0, '0', NULL, '', 'product', NULL, 0, b'1', b'1', b'1', 0, NULL, '2023-06-26 16:29:01', 'admin', '2023-07-07 16:54:02', b'0', '1');
...
INSERT INTO `sys_menu` VALUES ('2171', '日志管理', '', 2, 2, '2168', NULL, 'icon-filedone', NULL, NULL, 1, b'1', b'1', b'1', 0, NULL, '2023-06-26 16:44:25', 'admin', '2023-07-06 07:51:41', b'0', '1');
INSERT INTO `sys_menu` VALUES ('2172', '在线开发', '', 2, 3, '2168', NULL, 'icon-cloud', NULL, NULL, 1, b'1', b'1', b'1', 0, NULL, '2023-06-26 16:45:17', 'admin', '2023-07-06 07:51:34', b'0', '1');
...
INSERT INTO `sys_menu` VALUES ('2183', '附件管理', '', 2, 3, '2170', NULL, 'icon-folder-fill', 'sys/attachment/index', NULL, 1, b'1', b'1', b'1', 0, NULL, '2023-06-27 13:50:43', 'admin', '2023-07-06 08:12:44', b'0', '1');
INSERT INTO `sys_menu` VALUES ('2184', '参数管理', '', 2, 2, '2170', NULL, 'icon-filedone', 'sys/params/index', NULL, 1, b'1', b'1', b'1', 0, NULL, '2023-06-27 13:51:41', 'admin', '2023-07-06 08:12:56', b'0', '1');
INSERT INTO `sys_menu` VALUES ('2185', '接口文档', '', 2, 10, '2170', NULL, 'icon-file-text-fill', '{{apiUrl}}/doc.html', NULL, 1, b'1', b'1', b'1', 1, NULL, '2023-06-27 13:52:12', 'admin', '2023-07-06 08:12:51', b'0', '1');
...
INSERT INTO `sys_post` VALUES ('4', 'user', '普通员工777', 4, 0, '111', 'admin', '2021-01-05 17:03:48', 'admin', '2023-07-07 16:53:03', b'0', '1');
...
INSERT INTO `sys_role` VALUES ('101', '测试账号', 'test', 0, 1, '[]', 0, 2, '132', '', '2021-01-06 13:49:35', 'admin', '2023-07-07 16:53:41', b'0', '1');
...
INSERT INTO `sys_role_menu` VALUES ('2995', '101', '2167', 'admin', '2023-07-07 16:53:31', 'admin', '2023-07-07 16:53:36', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('2996', '101', '2216', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('2997', '101', '2215', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('2998', '101', '2214', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('2999', '101', '2213', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('3000', '101', '2212', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('3001', '101', '2211', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('3002', '101', '2210', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('3003', '101', '2164', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
INSERT INTO `sys_role_menu` VALUES ('3004', '101', '2209', 'admin', '2023-07-07 16:53:37', 'admin', '2023-07-07 16:53:40', b'1', '1');
...
INSERT INTO `sys_user` VALUES ('128', 'hqftest123', '{bcrypt}$2a$10$6tM5ihqRHZloc96TTZ0wGegAoPY7sR1F5KHhAwOnpfUn1q0dWidNW', 'hqf', '管理员', '105', '[\"4\"]', '', '13777777777', 1, 'https://cdn.maku.net/images/avatar.png', 0, '', NULL, NULL, '2023-06-28 17:01:24', 'admin', '2023-07-07 16:41:33', b'0', '1');
