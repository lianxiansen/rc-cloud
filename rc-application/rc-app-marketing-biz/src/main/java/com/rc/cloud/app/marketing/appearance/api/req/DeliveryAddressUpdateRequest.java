 ...
 * @Author liandy
 * @Date 2023/8/3 14:17
 * @Description 收货地址更新数据请求对象
 * @Version 1.0
 */
@Data
@Accessors(chain = true)
@Schema(description = "收货地址更新request")
public class DeliveryAddressUpdateRequest {
    @Schema(description = "id唯一标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "2967b268-38c7-45ee-bb7c-0c4e6e4")
    @NotBlank(message = "id唯一标识不能为空")
    private String id;
    /**
     * 姓名
     */
