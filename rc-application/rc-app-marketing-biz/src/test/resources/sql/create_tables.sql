...
(
    ...
    `pay_type`                tinyint(4) NULL DEFAULT 0 COMMENT '支付方式 0：扫码支付',
    ...
    `end_time`                datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '完成时间',
...
(
    ...
    `pay_type`      tinyint(4) NULL DEFAULT NULL COMMENT '支付方式 0 手动代付 1 微信支付 2 支付宝',
