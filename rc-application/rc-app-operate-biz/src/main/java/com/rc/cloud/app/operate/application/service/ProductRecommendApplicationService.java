...
@Service
public class ProductRecommendApplicationService {
    @Autowired
    private ProductRecommendDomainService ProductRecommendService;
    @Autowired
    private com.rc.cloud.app.operate.domain.model.productrecommend.ProductRecommendRepository ProductRecommendRepository;
    @Autowired
