...
import com.rc.cloud.ops.auth.support.CustomeOAuth2AccessTokenGenerator;
import com.rc.cloud.ops.auth.support.core.CustomeOAuth2TokenCustomizer;
...
import com.rc.cloud.ops.auth.support.handler.RcAuthenticationSuccessEventHandler;
import com.rc.cloud.ops.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.rc.cloud.ops.auth.support.password.OAuth2ResourceOwnerPasswordAuthenticationProvider;
	...
	public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		authorizationServerConfigurer.tokenEndpoint((tokenEndpoint) -> {// 个性化认证授权端点
			tokenEndpoint.accessTokenRequestConverter(accessTokenRequestConverter()) // 注入自定义的授权认证Converter
				.accessTokenResponseHandler(new RcAuthenticationSuccessEventHandler()) // 登录成功处理器
				.errorResponseHandler(new RcAuthenticationFailureEventHandler());// 登录失败处理器
		}).clientAuthentication(oAuth2ClientAuthenticationConfigurer -> // 个性化客户端认证
		oAuth2ClientAuthenticationConfigurer.errorResponseHandler(new RcAuthenticationFailureEventHandler()))// 处理客户端认证异常
