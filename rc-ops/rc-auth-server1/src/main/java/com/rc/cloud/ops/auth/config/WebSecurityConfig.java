...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/logWebSocket/**","/log/**","/oauth/**", "/webjars/**", "/doc.html", "/swagger-resources/**", "/v2/api-docs").permitAll()
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            response.getWriter().print(new Gson().toJson(CodeResult.fail(ResultCode.UNAUTHORIZED.getCode(), ResultCode.UNAUTHORIZED.getMsg())));
