...
import com.rc.cloud.ops.auth.service.JdbcClientDetailsServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(new ClassPathResource("rc.jks"), "123456".toCharArray());
