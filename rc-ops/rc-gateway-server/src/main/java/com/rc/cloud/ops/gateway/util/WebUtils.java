package com.rc.cloud.ops.gateway.util;
...
public class WebUtils {
    ...
    public static Mono<Void> getAuthFailResult(ServerHttpResponse response, Integer code) {
        ...
        byte[] responseByte = new Gson().toJson(CodeResult.fail(code, ResultCode.getValue(code).getMsg())).getBytes(StandardCharsets.UTF_8);
